...
var lyr_Incidencias_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Incidencias_3_4.png" /> Socavon / Hundimiento<br />\
    <img src="styles/legend/Incidencias_3_5.png" /> Coladera sin tapa<br />'
        });

lyr_Positron_0.setVisible(true);lyr_chicoloapan_1.setVisible(true);lyr_colonias_2.setVisible(true);lyr_Incidencias_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_chicoloapan_1,lyr_colonias_2,lyr_Incidencias_3];
...
lyr_Incidencias_3.set('fieldAliases', {'Marca temp': 'Marca temp', 'Tipo de pr': 'Tipo de pr', 'Nombre(s)': 'Nombre(s)', 'Apellido(s': 'Apellido(s', 'Telefono a': 'Telefono a', 'Municipio': 'Municipio', 'Colonia/Ba': 'Colonia/Ba', 'Avenida/Bo': 'Avenida/Bo', 'Numero ext': 'Numero ext', 'Numero Int': 'Numero Int', 'Codigo Pos': 'Codigo Pos', 'Manzana/Lo': 'Manzana/Lo', 'Lugar de r': 'Lugar de r', 'Lat': 'Lat', 'Long': 'Long', 'direccion': 'direccion', 'Telefono': 'Telefono', 'layer': 'layer', 'path': 'path', });
...
lyr_Incidencias_3.set('fieldImages', {'Marca temp': 'TextEdit', 'Tipo de pr': 'TextEdit', 'Nombre(s)': 'TextEdit', 'Apellido(s': 'TextEdit', 'Telefono a': 'TextEdit', 'Municipio': 'TextEdit', 'Colonia/Ba': 'TextEdit', 'Avenida/Bo': 'TextEdit', 'Numero ext': 'TextEdit', 'Numero Int': 'TextEdit', 'Codigo Pos': 'TextEdit', 'Manzana/Lo': 'TextEdit', 'Lugar de r': 'TextEdit', 'Lat': 'TextEdit', 'Long': 'TextEdit', 'direccion': 'TextEdit', 'Telefono': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
