...
map.getView().fit([-11016326.413392, 2196399.835558, -10995727.054378, 2206966.558326], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Chicoloapan</h2>';
        return titleElement;
    })(),
